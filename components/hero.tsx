...
export default function Hero(){
    return(
        <main className="    h-screen px-4 md:px-6 xl:px-28 2xl:px-64 py-24 text-white">
            <div className="flex justify-between">
                <div className="flex flex-col gap-14">
                    <h1 className=" text-6xl font-bold">FOLLOTECH</h1>
                    <p className="text-xl">
    Join the FOLLOTECH Revolution! <br /> more than just a coin, it's a dynamic fusion of crypto and social influence.
                ...
                <div>
                    <Image src={'/images/4739.jpg'} width={500} height={500} alt="haha" />
                </div>
            </div>
        </main>
    )
